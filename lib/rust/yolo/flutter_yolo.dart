...
// These functions have error during generation (see debug logs or enable `stop_on_error: true` for more details): `yolo_new_mem`, `yolo_new`
...
Future<List<FFIDetectionResult>> yoloPredict(
    ...
    RustLib.instance.api.crateYoloFlutterYoloYoloPredict(
        yoloHandle: yoloHandle, width: width, height: height, pixels: pixels);
