...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1743568639;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateYoloInitApp();

  Future<YoloHandle> crateYoloFlutterYoloYoloNew({
  ...
  Future<YoloHandle> crateYoloFlutterYoloYoloNewMem({
    required List<int> mem,
    required List<String> classLabels,
    required double confidenceThreshold,
    required double nmsThreshold,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateYoloInitApp() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateYoloInitAppConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateYoloInitAppConstMeta =>
  ...
  Future<YoloHandle> crateYoloFlutterYoloYoloNew({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateYoloFlutterYoloYoloNewConstMeta,
  ...
  TaskConstMeta get kCrateYoloFlutterYoloYoloNewConstMeta =>
      const TaskConstMeta(
        debugName: "yolo_new",
        argNames: [
          "modelPath",
  ...
  Future<YoloHandle> crateYoloFlutterYoloYoloNewMem({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_list_prim_u_8_loose(mem, serializer);
          sse_encode_list_String(classLabels, serializer);
          sse_encode_f_32(confidenceThreshold, serializer);
          sse_encode_f_32(nmsThreshold, serializer);
          pdeCallFfi(
        ...
        constMeta: kCrateYoloFlutterYoloYoloNewMemConstMeta,
        argValues: [mem, classLabels, confidenceThreshold, nmsThreshold],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateYoloFlutterYoloYoloNewMemConstMeta =>
      const TaskConstMeta(
        debugName: "yolo_new_mem",
        argNames: ["mem", "classLabels", "confidenceThreshold", "nmsThreshold"],
      );
