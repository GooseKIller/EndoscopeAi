...
// These functions are ignored because they are not marked as `pub`: `save_u8_vec_as_csv`
...
}) => RustLib.instance.api.crateYoloFlutterYoloYoloNew(
  modelPath: modelPath,
...
Future<YoloHandle> yoloNewMem({
  required List<int> mem,
  required List<String> classLabels,
  required double confidenceThreshold,
  required double nmsThreshold,
}) => RustLib.instance.api.crateYoloFlutterYoloYoloNewMem(
  mem: mem,
  classLabels: classLabels,
  confidenceThreshold: confidenceThreshold,
  nmsThreshold: nmsThreshold,
...
}) => RustLib.instance.api.crateYoloFlutterYoloYoloPredict(
